...
public class EnumKeyword : IJsonSchemaKeyword, IEquatable<EnumKeyword>
{
	...
	public void Validate(ValidationContext context)
	{
		...
		//[GuyT 2022-06-11] remove the emum validation, this should be change in the future
		//instead of ignoring the enum we should check on the enums that we recieve from the DB
